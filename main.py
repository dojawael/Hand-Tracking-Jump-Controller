...
while True:
    ...
    frame = cv2.flip(frame, 1)  # Flip the frame to correct mirroring
    ...
    hands, img = detector.findHands(frame, flipType=False)  # Prevent HandDetector from flipping landmarks
